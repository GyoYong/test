  ...
  */
  ...
  ///여기 피어에는 연결되는데 
    pc.onaddstream = function(event) {
      ...
      $body.removeClass('wait').addClass('connected'); //connected;;
    };
	...
	pc.ondatachannel = function(event) {
		  ...
		  receiveChannel.onmessage = function(event) {
			  ...
			  //chatArea.innerHTML += "<li class='odd'>"+connectedUser + ": " + event.data + "</li>"; 
			};     
		}; 
  ...
  */
  ...
  function initialize() {
    ...
    $('#start').click(function() {
		...
		//var tt = $roomInput.val();
		var tt2 = $userInput.val();
		if(!tt2){
			alert("이름을 입력해주세요.");
			return;
